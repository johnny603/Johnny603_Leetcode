/*
Start from each 1 in the grid.

Try all four diagonal directions from that starting point.

Use DFS to extend the path:

Must follow number sequence 1 → 2 → 0 → 2 → 0 ....

Can keep going straight OR make one optional diagonal turn.

Use memoization to avoid recalculating results for the same state.

Track the maximum path length across all attempts.
*/
