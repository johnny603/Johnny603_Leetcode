/*
- A 4D array used to memoize results for the state `(l, r, k)`, where:
  - `l` is the **position of firstPlayer from the front**,
  - `r` is the **position of secondPlayer from the end**,
  - `k` is the **number of players** in the current round.
- The result is a 2-element array: `{earliest, latest}` round.
*/
